    ...
    const syncLocalStorageWithSupabase = async (userId: string) => {
      try {
        ...
        if (storedProfile) {
          ...
          // Encrypt sensitive fields before mapping to database fields for update
          const encryptedParsedProfile = encryptProfileFields(parsedProfile, userId);

          // Map profile data to database fields
          if (encryptedParsedProfile.name) updateData.name = encryptedParsedProfile.name;
          if (encryptedParsedProfile.dateOfBirth) updateData.dob = encryptedParsedProfile.dateOfBirth;
          if (encryptedParsedProfile.location) updateData.location = encryptedParsedProfile.location;
          if (encryptedParsedProfile.gender) updateData.gender = encryptedParsedProfile.gender;
          if (encryptedParsedProfile.workplace) updateData.workplace = encryptedParsedProfile.workplace;
          if (encryptedParsedProfile.jobTitle) updateData.job_title = encryptedParsedProfile.jobTitle;
          if (encryptedParsedProfile.education) updateData.education = encryptedParsedProfile.education;
          if (encryptedParsedProfile.religiousBeliefs) updateData.religious_beliefs = encryptedParsedProfile.religiousBeliefs;
          if (encryptedParsedProfile.communicationPreferences) updateData.communication_style = encryptedParsedProfile.communicationPreferences;
          if (encryptedParsedProfile.availability) updateData.availability = encryptedParsedProfile.availability;
          if (encryptedParsedProfile.supportPreferences) updateData.support_preferences = encryptedParsedProfile.supportPreferences;
          if (encryptedParsedProfile.journeyNote) updateData.journey_note = encryptedParsedProfile.journeyNote;
          if (encryptedParsedProfile.supportType) updateData.support_type = encryptedParsedProfile.supportType;
          if (encryptedParsedProfile.completedSetup !== undefined) updateData.completed_setup = encryptedParsedProfile.completedSetup;
        }
